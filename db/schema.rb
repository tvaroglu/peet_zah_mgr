...
ActiveRecord::Schema[7.0].define(version: 2025_07_27_214610) do
  ...
  create_table "pizza_toppings", force: :cascade do |t|
    ...
    t.index ["pizza_id", "topping_id"], name: "index_pizza_toppings_on_pizza_and_topping", unique: true
  ...
  create_table "pizzas", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "lower((name)::text)", name: "index_pizzas_on_lower_name", unique: true
  ...
  create_table "toppings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "lower((name)::text)", name: "index_toppings_on_lower_name", unique: true
